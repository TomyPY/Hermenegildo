...
for (pelicula of peliculas) {
    if (pelicula.id == productID) {
        ...
        document.getElementsByClassName("info-stats-genre")[0].innerText = `Genre: ${pelicula.genre}`
        ...
        document.getElementsByClassName("preview-movie")[0].innerText = `Movie-${pelicula.releaseDate.split("-")[0]}-${pelicula.genre}`
